      ...
      <Container>
         <div style={starContainerStyle} >
            {Array.from({ length: maxRating }, (_, i) =>
               <Star key={i}
                  selected={hoveredRating ? hoveredRating >= i + 1 : rating >= i + 1}
         ...
         <p style={textStyle}>{maxRating === messages.length ? messages[hoveredRating ? hoveredRating - 1 : rating - 1] : hoveredRating || rating || ''}</p>
      </Container>
   )
}
